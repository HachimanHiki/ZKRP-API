...
// @Accept  application/json
// @Produce  application/json
// @Param eventName body selftype.EventName true "EventName"
...
func GetEvent (c *gin.Context) {
	...
	if c.BindJSON(&eventName) == nil {
		c.JSON(http.StatusOK, gin.H{
			"status": "success",
			"data": allEvent[eventName.Name],
		})
...
func DelEvent (c *gin.Context) {
	...
	if c.BindJSON(&eventName) == nil {
		if _, ok := allEvent[eventName.Name]; ok {
			delete(allEvent, eventName.Name)
